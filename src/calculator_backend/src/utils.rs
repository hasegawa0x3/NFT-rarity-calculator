...
pub fn fetch_personal_data(input: String) -> (Vec<std::collections::HashMap<String, String>> , Vec<String>) {
...
pub fn rare_rank(input: Vec<Vec<f64>>) -> Vec<Vec<f64>> {
    let mut output: Vec<Vec<f64>> = Vec::new();
    for col in input {
...
pub fn independent_test(first: Vec<f64>, second: Vec<f64>) -> Vec<Vec<f64>> {
